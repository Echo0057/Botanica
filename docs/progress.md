...
- **数据**:`src/data/plants.json`,共 223 条。
  ...
  - **联网富集(进行中)**:`scripts/enrichment/*.json` + `npm run enrich`(`scripts/apply-enrichment.mjs`)流水线,按学名合并字段并记录 `sources`。已富集 76/223 条:地被(6)+藤本(7)+水生(11)+常绿乔木(11)+落叶乔木(23)+灌木(18)。覆盖:高度/冠幅/耐寒区/来源 34% · 日照 48% · 水分 23% · 花期 31% · 花色 29% · 常绿/落叶 49% · 叶形 44% · 可靠度 47% · 生境 50%。
  - 已移除字段:香气(`fragrance`)/扩散(`spreadRate`)/自播(`selfSeeding`)(2026-08-27)。
...
1. 继续联网富集剩余字段:灌木(44)+宿根草本(103),补高度/冠幅/日照/水分/花期/花色/叶形/生境/耐寒区。
