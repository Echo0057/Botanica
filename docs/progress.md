...
- **数据**:`src/data/plants.json`,共 223 条。
  ...
  - **联网富集(进行中)**:`scripts/enrichment/*.json` + `npm run enrich`(`scripts/apply-enrichment.mjs`)流水线,按学名合并字段并记录 `sources`。已富集 126/223 条:地被(6)+藤本(7)+水生(11)+常绿乔木(11)+落叶乔木(23)+灌木(62)+宿根草本(6)。覆盖:高度/冠幅/耐寒区 57% · 日照 61% · 水分 37% · 花期 49% · 花色 46% · 常绿/落叶 52% · 叶形 64% · 可靠度 65% · 生境 62%。
