...
`id` · `chineseName` · `latinName` · `genus` · `family` · `aliases` · `category` · `evergreen` (evergreen/deciduous) · `height` · `spread` · `sun` (full sun / part shade / shade) · `water` (dry / medium / wet) · `bloomSeason` · `flowerColor` · `seasonOfInterest` · `leafForm` · `persistence` · `hardinessZone` · `missingName` · `genusOnly` · `tags[]` · `sources[]`.
